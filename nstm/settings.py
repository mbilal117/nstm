...
ROOT_URLCONF = 'nstm.urls'

WSGI_APPLICATION = 'nstm.wsgi.application'
...
MIDDLEWARE = [
    ...
    'nstm.apps.accounts.middleware.UserTimezoneMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'nstm/templates')
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'nstm.apps.notifications.context_processors.notifications',
            ],
        },
    },
]
...
LOCALE_PATHS = (
    os.path.join(BASE_DIR, 'nstm/locale'),
)
...
STATIC_ROOT = os.path.join(BASE_DIR, 'nstm/static')
...
CELERY_BEAT_SCHEDULE = {
    'send-scheduled-campaigns': {
        'task': 'nstm.apps.campaigns.tasks.send_scheduled_campaigns_task',
        'schedule': 60.0
    },
    'clean-lists-hard-bounces': {
        'task': 'nstm.apps.lists.tasks.clean_lists_hard_bounces_task',
