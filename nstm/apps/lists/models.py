...
from nstm.apps.lists.constants import ImportStatus, ImportStrategies
from nstm.apps.subscribers.constants import Status, TemplateKeys
from nstm.storage import PrivateMediaStorage
...
class SubscriberImport(models.Model):
    ...
    class Meta:
        ...
        db_table = 'nstm_subscribers_imports'
