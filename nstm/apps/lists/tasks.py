...
from nstm.apps.lists.constants import (
    ImportFields, ImportStatus, ImportStrategies,
)
from nstm.apps.notifications.constants import Actions
from nstm.apps.notifications.models import Notification
from nstm.apps.subscribers.constants import ActivityTypes, Status
from nstm.apps.subscribers.models import Domain, Subscriber
...
def clean_list_task(mailing_list_id):
    try:
        ...
        if settings.MAILGUN_API_KEY:
            from nstm.apps.core.mailgun import Mailgun
            client = Mailgun()
