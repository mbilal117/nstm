...
from nstm.apps.campaigns.models import Campaign, Email, Link
from nstm.apps.core.models import City, Token
from nstm.apps.lists.models import MailingList
from nstm.apps.subscribers.exceptions import (
    FormTemplateIsNotEmail, FormTemplateIsNotForm,
)
from nstm.apps.subscribers.tasks import (
    update_click_rate, update_open_rate,
    update_rates_after_subscriber_deletion, update_subscriber_location,
)
from nstm.utils import get_absolute_url, get_client_ip
...
class SubscriptionFormTemplate(models.Model):
    ...
    def get_form_class(self):
        ...
        from nstm.apps.subscribers import forms
